...
8.	Кликнуть по кнопке "Продолжить"
      **Ожидаемый результат:**
      Отображается всплывающее окно с сообщением:
      "Успешно.
...
8.	Кликнуть по кнопке "Продолжить"
      **Ожидаемый результат:**
      Отображается сообщение под полем "Номер карты":
      "Неверный формат".
...
8.	Кликнуть по кнопке "Продолжить"
      **Ожидаемый результат:**
      Отображается сообщение под полем "Месяц":
      "Неверный формат".
...
8.	Кликнуть по кнопке "Продолжить"
      **Ожидаемый результат:**
      Отображается сообщение под полем "Год":
...
8.	Кликнуть по кнопке "Продолжить"
      **Ожидаемый результат:**
      Отображается сообщение под полем "Владелец":
...
8.	Кликнуть по кнопке "Продолжить"
      **Ожидаемый результат:**
      Отображается сообщение под полем "CVC/CVV":
      "Неверный формат"
...
с 15 мая по 20 мая - подготовка окружения
с 21 мая по 31 мая - написание и отладка авто-тестов
с 01 июня по 06 июня - подготовка отчетных документов
